    ...
    try {
      ...
      while (!connectionSocket.isClosed()) {
        ...
        if (packetType == 0) { // If the packet is for transferring the filename
          ...
          byte[] filenameDecrypted = Utils.decrypt(filename, privateKey);
          //          String decryptedFileName = "outputfiles/recv_" + new
          ...
          byte[] decryptedBlock = Utils.decrypt(block, privateKey);
